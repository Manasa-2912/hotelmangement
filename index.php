...
<div class="banner-top">
			...
			<div class="contact-bnr-w3-agile">
				<ul>
					<li><i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:info@example.com">INFO@SITARA.COM</a></li>
					<li><i class="fa fa-phone" aria-hidden="true"></i>9493551326</li>	
					<li class="s-bar">
						<div class="search">
		...
		<div class="container">
			<nav class="navbar navbar-default">
				<div class="navbar-header navbar-left">
					...
					<h1><a class="navbar-brand" href="index.php">SITARA<p class="logo_w3l_agile_caption">Your Dreamy Resort</p></a></h1>
				</div>
				...
				<ul class="cbp-ig-grid">
					<li>
						<div class="w3_grid_effect">
							...
							<span class="cbp-ig-category">SITARA</span>
						</div>
					</li>
					<li>
						<div class="w3_grid_effect">
 	...
 	<div class="about-wthree" id="about">
		  <div class="container">
				   <div class="ab-w3l-spa">
                            <h3 class="title-w3-agileits title-black-wthree">About Our SITARA</h3> 
						   <p class="about-para-w3ls">Hotel Sitara is constructed in a place where there is greenary everywhere.The facilities we provide are room service with good staff,24 hours restuarant,clean and neat surroundings.Customer Satisfaction is more important for us then anything else.</p>
					...
					<ul class="slides">
						...
						<li>
							...
							<div class="w3layouts_work_grid_right">
								...
								<p>It is cool.Simply Come and Enjoy!! </p>
								<h5>Arun</h5>
								<p>India</p>
							</div>
							<div class="clearfix"> </div>
						...
						<li>
							...
							<div class="w3layouts_work_grid_right">
								...
								<p>I enjoyed a lot here and next time iam planning to come with my family </p>
								<h5>Huma Fathima</h5>
								<p>India</p>
							</div>
							<div class="clearfix"> </div>
...
<section class="contact-w3ls" id="contact">
	<div class="container">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Phone :</strong>+91 9493551326</p>
			<p class="contact-agile1"><strong>Email :</strong> <a href="mailto:name@example.com">INFO@Sitara.COM</a></p>
			<p class="contact-agile1"><strong>Address :</strong> Begumpet,Hyderabad.</p>
...
<!-- /contact -->
			<div class="copy">
		        <p>© 2021 sitara. All Rights Reserved | Design by <a href="index.php">C_FS14</a> </p>
		    </div>
<!--/footer -->
<!-- js -->
